...
def app():
    ...
    from_display = format_value(value, result.from_unit.abbreviation)
    to_display = format_value(result.to_value, result.to_unit.abbreviation, places)
